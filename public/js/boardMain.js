...
/*
*** Revision :
*** V1.0 : 曾根 悠太悠太, 2022.06.25
*** V1.1 : 曾根 悠太悠太, 2022.06.26
*** V1.2 : 曾根 悠太悠太, 2022.06.28
*** V1.3 : 曾根 悠太悠太, 2022.06.30
*** V1.4 : 曾根 悠太悠太, 2022.07.06
*** V1.5 : 曾根 悠太悠太, 2022.07.10
*/
...
function init()
{
  ...
  *** Return              : なし
  ****************************************************************************/        
  function hoverItem(raycaster) //raycaster
  {
  ...
  *** Return              : なし
  ****************************************************************************/
  function itemCreate(num, //アイテム配列の順番
                      scene) //three.jsのシーン
  {
  ...
  ****************************************************************************/        
  ...
  function tick()
  {
    ...
    //表示しているアイテムとアイテムデータが異なる場合，アイテムを再設置
    for(i = 0; i < 4;i++){
